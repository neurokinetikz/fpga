...
- Beta (15.42 Hz, 24.94 Hz) and gamma (40.36 Hz):
  - Full power in NORMAL phases (0-20s, 80-100s)
  - Reduced amplitude (~50%) in MEDITATION phase (40-60s)
...
def main():
    ...
    for freq, label in phi_freqs.items():
        if freq <= 80:
            ...
            ax1.text(2, freq + 1.5, label, color='white', fontsize=8, alpha=0.8)
    ...
    ax2.text(5, 4.2, 'NORMAL (μ=4)', color='green', fontsize=9)
    ax2.text(45, 2.2, 'MEDITATION (μ=2)', color='blue', fontsize=9)
